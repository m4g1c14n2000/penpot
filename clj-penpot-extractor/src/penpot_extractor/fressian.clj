;; Standalone Fressian implementation for Penpot
;; Based on Penpot's app.common.fressian but without dependencies on app.common.data

(ns penpot-extractor.fressian
  (:require
...
;; --- Ordered collections (standalone implementations)
...
(add-handlers!
 ...
 {:name "linked/set"
  :class LinkedSet
  :wfn write-list-like
  :rfn (comp #(into (ordered-set) %) read-object!)})
